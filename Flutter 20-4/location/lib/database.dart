...
class DatabaseHelper {
  ...
  initDb() async {
    ...
    var theDb = await openDatabase(path, version: 1, onOpen: (db) {},
      ...
      db.execute(
          'CREATE TABLE locationdata(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,accuracy DOUBLE, timeSpan DATETIME , lat DOUBLE,long  DOUBLE )');
    });
    print(path);
...
class LocationData {
  ...
  @override
  String toString() {
    return 'LocationData{accuracy:$accuracy, timeSpan: $timeSpan, lat: $lat, long:$long}';
  }
}
